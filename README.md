...
ソクラテスの産婆術に着想を得ています。回答者に深い考察を求めるのではなく、会話記録を読んだ主催者が考察を得やすくすることを目指します。
...
- 会話記録を JSONL と JSON ダウンロード、NotebookLM などで分析する用途を想定
...
> 目的は、直接役立つ分かりやすいフィードバックを生成することではなく、散漫でもよいので率直な感想を集めることです。
...
4. 会話記録を保存し、主催者が後から読み返して分析できる形で残す
